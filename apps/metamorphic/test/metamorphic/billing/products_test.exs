defmodule Metamorphic.Billing.ProductsTest do
  use Metamorphic.DataCase

  alias Metamorphic.Billing.Products
  alias Metamorphic.Billing.Product
  ...
  describe "products" do
    ...
    test "with_plans/ laods the plans for a list of products" do
      product = product_fixture()
      assert [%Product{plans: []}] = Products.with_plans([product])
    end
    ...
    test "get_product_by_stripe_id!/1 returns the product with the given stripe_id" do
      product = product_fixture()
