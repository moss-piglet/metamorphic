defmodule MetamorphicWeb.Extensions.MaxTOTPProcessor do
  @moduledoc """
  A GenServer to limit TOTP in attempts to 5
  every hour.
  """
  use GenServer

  @max_per_hour 5
  @sweep_after :timer.hours(3)
  @tab :totp_rate_limiter_requests
